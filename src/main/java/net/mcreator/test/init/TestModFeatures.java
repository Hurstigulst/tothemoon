...
import net.mcreator.test.world.features.ores.SapphireOreFeature;
...
import net.mcreator.test.world.features.CraterFeature;
...
public class TestModFeatures {
	...
	public static final RegistryObject<Feature<?>> CRATER = REGISTRY.register("crater", CraterFeature::feature);
