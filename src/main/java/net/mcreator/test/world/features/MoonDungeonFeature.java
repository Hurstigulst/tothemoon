...
public class MoonDungeonFeature extends Feature<NoneFeatureConfiguration> {
	public static MoonDungeonFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MoonDungeonFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("test:moon_dungeon", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("test:moon_dungeon", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("test", "moondungeon"));
		if (template == null)
			return false;
